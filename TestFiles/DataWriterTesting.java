...
//Same data writer, except it has different outputs
public class DataWriterTesting extends DataConstants {
    public static void writeStudent() {
        try {
            ...
            FileWriter output = new FileWriter(new File("src/STUDENT_FILE_NAME.json"));
    ...
    public static void writeCourses() {
        try {
            ...
            FileWriter output = new FileWriter(new File("src/COURSE_FILE_NAME.json"));
    ...
    public static void writeMajorList() {
        try {
            ...
            FileWriter output = new FileWriter(new File("src/DEGREE_FILE_NAME.json"));
    ...
    public static void writeAdvisorList() {
        try {
            ...
            FileWriter output = new FileWriter(new File("src/ADVISOR_FILE_NAME.json"));
